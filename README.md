...
- **84 pitanja** u bazi, **25 nasumičnih po rundi**
...
- **Admin panel** sa istorijom svih rezultata i detaljnom statistikom (lozinka)
...
- **Takmičari** — po osobi: broj rundi, najbolji i prosečan rezultat, tačnost,
  koliko je pitanja savladao od 84, najduži niz, prosečno vreme po pitanju
...
- **CSV izvoz** — svaki pojedinačni odgovor, za Excel
...
oba u istu rundu. U bazi trenutno ima 17 takvih parova.
...
| 📋 Klasično | 45s | 100 | — |
| ⚡ Brzi metak | 10s | 150 | — |
| ✂️ Pola-pola | 20s | 140 | posle 7s nestaje jedan netačan, bodovi se prepolove |
| 🎲 Duplo ili ništa | 30s | 100 | tačno = ×2, netačno = −100 |
| 🔥 Munja | 8s | 200 | poslednja pitanja u rundi |
...
src/
  ...
  lib/
    ...
    stats.ts              obrada statistike za admin
